...
void solve()
{
  ...
  for (ll i = 0; i < n; i++)
  {
    ...
    else
    {
      ...
      // }
      if (p < (*it) && ((i < k) && (st.size() % 2 == 0) || (i >= k && make_pair(arr[i - k], i - k) > (*it))))
      {
        if (i >= k)
        {
          if (k % 2 == 1)
      ...
      else if ((p > (*it)) && (i < k && (st.size() % 2 == 1) || (i >= k && (make_pair(arr[i - k], i - k) < (*it)))))
      {
        if (i >= k)
        {
          if (k % 2 == 1)
      ...
      else if ((p > (*it)) && (i < k && (st.size() % 2 == 0) || (i >= k && (make_pair(arr[i - k], i - k) >= (*it)))))
      {
        if (i >= k)
        {
    ...
    // cout << "med: " << it->first << " " << it->second << endl;
    // cout << "temp: " << temp << endl;
    if (i >= k - 1)
    {
      cout << temp << " ";
